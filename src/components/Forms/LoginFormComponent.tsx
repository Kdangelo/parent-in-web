...
const LoginFormComponent = () => {
  ...
  return (
    <div className="relative flex h-screen w-full font-sans bg-[#C2D0F0] overflow-hidden">
      <div 
      ...
      <div className="hidden lg:flex relative z-10 w-1/2 flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center mt-10 w-full px-4">
            <div className="w-[85%] max-w-[400px] xl:max-w-[600px] 2xl:max-w-[550px] mb-4 transition-all duration-300">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 relative z-10">
        <div className="bg-white flex flex-col items-center w-full max-w-[670px] 2xl:max-w-[850px] h-auto shadow-[0px_4px_60px_0px_#A4B5DB99] rounded-[20px] py-[80px] px-[5%] justify-center transition-all duration-300">
            ...
            <div className="flex items-end mb-8 w-full max-w-[556px] 2xl:max-w-[700px] gap-2 md:gap-[10px] pb-[25px]">
                <div className="flex items-center justify-center w-1/2 h-[68px] border-b-2 border-black">
                    <span className="font-bold text-[18px] md:text-[20px] text-[#393939]">Sign In</span>
                </div>
                <Link to="/register" className="flex items-center justify-center w-1/2 h-[68px] border-b-2 border-[#D9D9D9] hover:bg-gray-50 transition cursor-pointer">
                    <span className="font-bold text-[18px] md:text-[20px] text-[#737373]">Sign Up</span>
                </Link>
            </div>
            ...
            <button type="button" className="flex items-center justify-center gap-4 hover:bg-gray-50 transition w-full max-w-[556px] 2xl:max-w-[700px] h-[80px] rounded-[10px] border border-[#8F9AB2] bg-white mb-0">
                ...
                <span className="font-bold text-[16px] md:text-[20px] text-[#393939]">Sign in with Google</span>
            </button>
            ...
            <form className="w-full flex flex-col items-center" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-center justify-center text-center w-full max-w-[556px] 2xl:max-w-[700px] h-[64px]">
                  <p className="font-bold text-[14px] text-[#393939] leading-[1.4]">
                    Don't remember your password? or <br/>
                    <Link to="#" className="underline">Change your password</Link>
                  </p>
              </div>

              <button type="submit" disabled={loading} className="flex items-center justify-center transition-all duration-200 hover:bg-[#FDFD75] hover:scale-[1.01] hover:shadow-lg w-full max-w-[556px] 2xl:max-w-[700px] h-[80px] rounded-[10px] bg-[#FDFD96] border border-[#393939] mt-0 disabled:opacity-70 disabled:cursor-not-allowed">
                {loading ? <svg className="animate-spin h-6 w-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg> : <span className="font-bold text-[20px] text-[#393939] uppercase">SIGN IN</span>}
              </button>
            </form>
        </div>
      </div>
