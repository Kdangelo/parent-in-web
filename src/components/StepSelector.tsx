  ...
  return (
    <motion.button
      ...
      className={`
        ...
        ${isSelected ? "text-blue-400 ring-[hsla(0,0%,100%,0.12)]" : "text-white ring-[hsla(0,0%,100%,0.06)]"}
      `}
    >
      <motion.div
    ...
    <div className="min-h-screen bg-[#F7F6F1] flex items-center justify-center p-6">
      <div className="w-full max-w-[540px]">
        <div className="mb-12">
          ...
          <div className="w-full h-1 bg-green-500 rounded-full overflow-hidden">
            <motion.div
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {currentStep === 1 && (
              <div>
                <h1 className="text-black text-xl font-semibold mb-4">Pre Licencia</h1>
                <p className="text-zinc-600 text-base mb-12">Seleccione .....</p>
                <motion.div className="flex flex-col flex-wrap gap-3 overflow-visible" layout transition={transitionProps}>
                  {PRE_LICENCIA.map((level, index) => (
                    <ChipButton
                      key={level}
                      label={`${index + 1} - ${level}`}
